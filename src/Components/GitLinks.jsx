    ...
    return (
        <div className="column git-links">
            ...
            <div className="cell">
                ...
                {isAvailableSocial(props.twitter, `https://twitter.com/${props.twitter}`, 'Twitter', props.theme)}
            </div>
            <div className="cell">
                <span className="icon">
            ...
            <div className="cell">
                ...
                {isAvailableSocial(props.blog, `https://github.com/${props.git}`, 'Github', props.theme)}
            </div>
        </div>
    )
}
